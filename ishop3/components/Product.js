...
class Product extends React.Component {
    ...
    render () {
        return <tr onClick={this.colorProduct} style={{backgroundColor:((this.props.colorProduct === this.props.code) && (!this.props.add))?'orange':'white'}}>
                  ...
                  <td>
                    ...
                    <input type='button' value={this.props.controlEd} className='Product' onClick={this.editProduct} disabled/>
                    :
                    <input type='button' value={this.props.controlEd} className='Product' onClick={this.editProduct} />
                    }
                    {(this.props.editStart || this.props.add) ?
                    <input type='button' value={this.props.control} className='Product' onClick={this.deleteProduct} disabled/>
                    :
                    <input type='button' value={this.props.control} className='Product' onClick={this.deleteProduct} />
                    }
                  </td>
                </tr>
    }
